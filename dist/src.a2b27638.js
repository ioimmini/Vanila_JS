...
var generate = document.querySelector("#random_number .generate");
var guess = document.querySelector("#random_number .guess");
var greeting = document.querySelector("#greeting");
var greeting2 = document.querySelector("#greeting2");
function onSubmit(event) {
  event.preventDefault();
  var newnum = generate.value;
  var selectnum = parseInt(guess.value);
  var correct = Math.floor(Math.random() * newnum);
  localStorage.setItem("selectnum", selectnum);
  console.log(correct, selectnum);
  greeting.classList.remove("hidden");
  greeting.innerText = "You chose : ".concat(selectnum, ", the machine chose : ").concat(correct);
